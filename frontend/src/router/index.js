...
const routes = [
  { path: '/login', name: 'Login', component: () => import('../views/Login.vue') },
  {
    ...
    children: [
      ...
      { path: 'venues', name: 'Venues', component: () => import('../views/VenueList.vue'), meta: { title: '场地管理' } },
      ...
      { path: 'my-applications', name: 'MyApplications', component: () => import('../views/ApplicationCenter.vue'), meta: { title: '我的全部申请' } },
      { path: 'admin', name: 'Admin', component: () => import('../views/AdminPage.vue'), meta: { title: '管理员审批' } },
    ]
  }
]
